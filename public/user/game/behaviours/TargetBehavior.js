//File: /user/game/behaviours/TargetBehavior.js

//A behavior controlling the movement of a target
...
export default class CircleBehaviour extends Base.Behavior {
	...
	*/
    start() {
        this.target = this.gameObject.getComponent(CircleComponent);
	...
	*/
    pulse() {
        ...
        if(Input.keys[' '] || Input.touch) {
            ...
            //NEED TO DETECT COLLISION - ARE WE IN COLLISION BOUNDS?
                //ARE WE OUT OF BOUNDS SLIGHTLY (VISUALIZE WITH SHIELD)
                //DID WE MISS COMPLETELY?
